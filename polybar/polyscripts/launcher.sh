...
FILE="$HOME/.config/polybar/polyscripts/rofi/colors.rasi"
...
rofi -no-config -no-lazy-grab -show drun -modi drun -theme ~/.config/polybar/polyscripts/rofi/launcher.rasi
